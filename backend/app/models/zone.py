...
class Zone(UUIDPrimaryKeyMixin, TimestampMixin, AuditMixin, ActiveMixin, Base):
    ...
    worker_profiles = relationship("WorkerProfile", back_populates="zone")
    ...
    pickup_tasks = relationship("PickupTask", back_populates="zone")
    processing_facilities = relationship("ProcessingFacility", back_populates="zone")
    collected_batches = relationship("CollectedBatch", back_populates="zone")
